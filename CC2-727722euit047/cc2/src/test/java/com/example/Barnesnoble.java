...
public class Barnesnoble {
   ...
   final Logger lobj = Logger.getLogger(getClass());
    ...
    public void setup()
    {
        ExtentSparkReporter sparkReporter = new ExtentSparkReporter("C:\\Users\\divya\\OneDrive\\Desktop\\softwaretest\\report.html");
    ...
    {  
        FileInputStream fs=new FileInputStream("C:\\Users\\divya\\OneDrive\\Desktop\\CC2\\CC2\\ccexcel.xlsx");
