...
public class Mayoclinic {
    ...
    public void before() throws Exception{
        ExtentSparkReporter exsprk = new ExtentSparkReporter("C:\\Users\\divya\\OneDrive\\Desktop\\softwaretest\\ModelLab\\mayoclinic\\logandreport\\report1.html");
    ...
    public void test() throws IOException, InterruptedException
    {
        ...
        PropertyConfigurator.configure("C:\\Users\\divya\\OneDrive\\Desktop\\softwaretest\\ModelLab\\mayoclinic\\mc\\src\\main\\resources\\log4j2.properties");
        WebDriverManager.chromedriver().setup();
        driver = new ChromeDriver();
        driver.manage().window().maximize();
        FileInputStream fs = new FileInputStream("C:\\Users\\divya\\OneDrive\\Desktop\\softwaretest\\ModelLab\\mayoclinic\\mclinic.xlsx");
    ...
    public void afterTest(ITestResult result) throws Exception{
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String path = "C:\\Users\\divya\\OneDrive\\Desktop\\softwaretest\\ModelLab\\mayoclinic\\logandreport"+result.getName()+"png";
